        ...
        <header className='flexed z-50 w-screen p-3 px-4 md:p-6 md:px-16'>
            ...
            <Link to={"/"} className='flex items-center gap-2'>
                ...
                <ul className='flex flex-col px-4 py-2  gap-8'>
                    <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 m'>Home</li>

...
const Header = () => {
    ...
    return (
        <header className='flexed z-50 w-screen p-3 px-4 md:p-6 md:px-16'>
            {/* desktop & tablet */}
            <div className='hidden md:flex w-full h-full items-center justify-between'>
...

                {
                    ...
                    {
                        user && user.email === "shorifuddin240915@gmail.com" && (
            ...
            <Link to={"/"} className='flex items-center gap-2'>
                ...
                <ul className='flex flex-col  gap-8'>
                    ...
                    <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-'>Menu</li>
                    <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-'>About Us</li>
